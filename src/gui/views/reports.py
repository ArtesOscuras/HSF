...
class ReportsView(BaseView):
    ...
    def _build_ui(self):
        ...
        build_nav(header, "reports", self.master)
    ...
    def _poll(self):
        ...
        if not files:
            ...
            self.text.insert(tk.END, "No reports found.\n", "muted")
        else:
            for f in files:
