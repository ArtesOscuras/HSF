...
_DEFAULTS = {
    ...
    "prompts": {
        "system": (
            ...
            "- Web: websearch (25 results), webfetch (read URLs; navigation, footers, "
            "sidebars, and cookie banners are automatically stripped from fetched "
            "HTML pages to show only main content; auto-saves visited URL paths to "
            "the directories table for known machines/domains), list_repo (browse "
            ...
            "cached tool outputs with offset/limit), shell operations.\n"
            ...
            "output if you need more detail.\n"
